...
# For Webcam: cv2.VideoCapture(0), for ip cam : 'http://192.168.1.102:8090'
video = cv2.VideoCapture('http://192.168.1.101:8080/video')
ret = video.set(3,640)
ret = video.set(4,480)
...
while(True):
    ...
    if(GetClassName(data) == "forward"):
        serial_port.write('1'.encode())
        print("Going forward")
        time.sleep(1)
    elif(GetClassName(data) == "forward_left"):
    ...
    cv2.imshow('Obj detection', cv2.resize(frame, (640,480)))
